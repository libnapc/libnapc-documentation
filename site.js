...
window.hljs = hljs;
		...
		console.log("Loaded file '3rd/highlightjs.js'");
	} catch (e) {
		console.error("Error in file '3rd/highlightjs.js'", e);
	}
})();
...
window.napcdoc.lib.fixLink = function(link) {
	...
	return `./../`.repeat(pieces.length - 1) + link
		...
		console.log("Loaded file 'documentation/fixLink.js'");
	} catch (e) {
		console.error("Error in file 'documentation/fixLink.js'", e);
	}
})();
...
(function() {
	...
	return window.napcdoc.lib.getSVGMarkup(icon, width, height)
		...
		console.log("Loaded file 'documentation/getIconOfDefinition.js'");
	} catch (e) {
		console.error("Error in file 'documentation/getIconOfDefinition.js'", e);
	}
})();

(function() {
	try {
		window.napcdoc.lib.getIconOfModule = function(module_name, width, height) {
	return window.napcdoc.lib.getSVGMarkup(`module_icon/${module_name}`, width, height)
}

		console.log("Loaded file 'documentation/getIconOfModule.js'");
	} catch (e) {
		console.error("Error in file 'documentation/getIconOfModule.js'", e);
	}
})();
...
window.napcdoc.lib.getModuleOfDefinition = function(definition_name) {
	for (const module_name in window.napcdoc.modules) {
		...
		console.log("Loaded file 'documentation/getModuleOfDefinition.js'");
	} catch (e) {
		console.error("Error in file 'documentation/getModuleOfDefinition.js'", e);
	}
})();
...
(function() {
	...
	return "???"
		...
		console.log("Loaded file 'formatting/getProtoOfDefinition.js'");
	} catch (e) {
		console.error("Error in file 'formatting/getProtoOfDefinition.js'", e);
	}
})();
...
(function() {
	...
	return out
		...
		console.log("Loaded file 'formatting/replaceBackticks.js'");
	} catch (e) {
		console.error("Error in file 'formatting/replaceBackticks.js'", e);
	}
})();
...
(function() {
	...
	return ret
		...
		console.log("Loaded file 'global-search/createGlobalSearchSpace.js'");
	} catch (e) {
		console.error("Error in file 'global-search/createGlobalSearchSpace.js'", e);
	}
})();
...
window.napcdoc.lib.initGlobalSearch = function() {
	...
	document.body.addEventListener("click", e => {
		...
		console.log("Loaded file 'global-search/init.js'");
	} catch (e) {
		console.error("Error in file 'global-search/init.js'", e);
	}
})();
...
window.napcdoc.lib.initLocalSearch = function() {
	...
	document.querySelector("#nd-local-search-input").addEventListener("input", (e) => {
		...
		console.log("Loaded file 'local-search/init.js'");
	} catch (e) {
		console.error("Error in file 'local-search/init.js'", e);
	}
})();
...
document.querySelector("#toggle-mobile-menu").addEventListener("click", (e) => {
	...
	if (document.body.classList.contains("mobile-navigation-open")) {
		...
		console.log("Loaded file 'mobile-navigation.js'");
	} catch (e) {
...
window.napcdoc.lib.getPopoverContent = function(definition_name, definition) {
	...
	return ret
		...
		console.log("Loaded file 'popover/getPopoverContent.js'");
	} catch (e) {
		console.error("Error in file 'popover/getPopoverContent.js'", e);
	}
})();
...
window.napcdoc.lib.initPopover = function() {
	...
	document.querySelector("#napcdoc-layout-content").addEventListener("scroll", (e) => {
		...
		console.log("Loaded file 'popover/initPopover.js'");
	} catch (e) {
		console.error("Error in file 'popover/initPopover.js'", e);
	}
})();
...
(function() {
	...
	console.log("inc", window.napcdoc._blur_counter)
		...
		console.log("Loaded file 'util/blurContent.js'");
	} catch (e) {
		console.error("Error in file 'util/blurContent.js'", e);
	}
})();
...
(function() {
	...
	return window.napcdoc.definitions[definition_name]
		...
		console.log("Loaded file 'util/getDefinition.js'");
	} catch (e) {
		console.error("Error in file 'util/getDefinition.js'", e);
	}
})();
...
(function() {
	...
	`
		...
		console.log("Loaded file 'util/getSVGMarkup.js'");
	} catch (e) {
		console.error("Error in file 'util/getSVGMarkup.js'", e);
	}
})();
...
(function() {
	...
	return string.replace(reg, function(str) {return `<${html_element}>${str}</${html_element}>`;});
		...
		console.log("Loaded file 'util/highlightString.js'");
	} catch (e) {
		console.error("Error in file 'util/highlightString.js'", e);
	}
})();
...
window.napcdoc.lib.isInViewPort = function(element) {
	...
	return (
		...
		console.log("Loaded file 'util/isInViewport.js'");
	} catch (e) {
		console.error("Error in file 'util/isInViewport.js'", e);
	}
})();
...
(function() {
	...
	return fallback
		...
		console.log("Loaded file 'util/localStorageGet.js'");
	} catch (e) {
		console.error("Error in file 'util/localStorageGet.js'", e);
	}
})();
...
(function() {
	...
	try {
		...
		console.log("Loaded file 'util/localStorageSet.js'");
	} catch (e) {
		console.error("Error in file 'util/localStorageSet.js'", e);
	}
})();
...
window.napcdoc.lib.search = function(search_space, search_term, highlight_element) {
	...
	return results.map(result => {
		...
		console.log("Loaded file 'util/search.js'");
	} catch (e) {
		console.error("Error in file 'util/search.js'", e);
	}
})();
...
(function() {
	...
	console.log("dec", window.napcdoc._blur_counter)
		...
		console.log("Loaded file 'util/unblurContent.js'");
	} catch (e) {
		console.error("Error in file 'util/unblurContent.js'", e);
	}
})();
